...
export function Scene() {
  ...
  return <>
    ...
    <pointLight castShadow args={['#f00', 14, 7, 1]} position={[3, 5.4, 0]}/>
    <pointLight castShadow args={['#0f0', 14, 7, 1]} position={[7, 5.4, -3.5]}/>
    <pointLight castShadow args={['#00f', 14, 7, 1]} position={[3, 5.4, -7]}/>
      <Ground />
      <Box position={[2.5, 0.25, -2.5]} rotation={[0, Math.PI / 4, 0]} scale={0.5}/>
      <Box position={[2.5, 0.5, -4.5]}/>
      <Box position={[2.5, 0.5, -7.5]}/>
      
      <mesh castShadow position={[1, 0, -4]} scale={[2, 2, 2]} userData={{ material: 'concrete' }}>
